<li class = "dropdown">
	...
	<ul class = "dropdown-menu">
		<%--
		<li><a href = javascript:void(0) onclick = $("#exportAnimationParamsDialog").modal("show")>Animation</a></li>
		<li><a href = javascript:void(0) onclick = prepareImageExport()>Image</a></li>
